...
public:
    ...
    */
    ...
    StkFloat tick( bool blit_on_ = true );
...
inline StkFloat BlitSaw :: tick( bool blit_on_ )
{
    ...
    {
        float phase_two_pi = phase_/TWO_PI;
        lastFrame_[0] = ((phase_two_pi - floor(phase_two_pi))*4.0f - 1)*-1;
    }
