...
template<int num_channels>
void mono_AudioSampleBuffer<num_channels>::setSize(int newNumSamples, bool keepExistingContent, bool clearExtraSpace, bool avoidReallocating) noexcept
{
...
template<int num_channels>
mono_AudioSampleBuffer<num_channels>::~mono_AudioSampleBuffer() noexcept {}

template<int num_channels>
void mono_AudioSampleBuffer<num_channels>::allocateData() noexcept {
