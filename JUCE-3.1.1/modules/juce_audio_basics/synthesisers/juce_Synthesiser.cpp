                          ...
                          const float velocity)
{
    ...
    keys_down.insert( 0, midiNoteNumber );
    velocitys_down.insert( 0, velocity );
                           ...
                           const bool allowTailOff)
{
    ...
    int note_index = keys_down.indexOf( midiNoteNumber );
    keys_down.remove(note_index);
    velocitys_down.remove(note_index);
...
void Synthesiser::allNotesOff (const int midiChannel, const bool allowTailOff)
{
    ...
    keys_down.clearQuick();
    velocitys_down.clearQuick();
        ...
        const bool stealIfNoneAvailable) const
{
    ...
    for (int i = 0; i < voices.size(); ++i)
    {
        ...
        if ((! voice->isVoiceActive()) /* HACK && voice->canPlaySound (soundToPlay)*/ )
            return voice;
    }
        ...
        int /*midiChannel*/, int midiNoteNumber) const
{
    ...
    for (int i = 0; i < voices.size(); ++i)
    {
        ...
        // HACK if (voice->canPlaySound (soundToPlay))
        {
