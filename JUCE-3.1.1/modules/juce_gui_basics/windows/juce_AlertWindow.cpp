...
void AlertWindow::updateLayout (const bool onlyIncreaseSize)
{
    ...
    int w = jmin ( int((1.f/ 900 * desktop_height * 300)) + sw * 2, (int) (getParentWidth() * 0.7f));
    ...
    w = jmax ( int((1.f/ 900 * desktop_height * 350)) , (int) textLayout.getWidth() + iconSpace + edgeGap * 4);
