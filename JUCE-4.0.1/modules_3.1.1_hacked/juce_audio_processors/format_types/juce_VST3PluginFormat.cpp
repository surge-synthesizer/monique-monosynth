    ...
    static void toProcessContext (Vst::ProcessContext& context, AudioPlayHead* playHead, double sampleRate)
    {
        ...
        if (playHead != nullptr)
        {
            ...
            case AudioPlayHead::fps24:
                context.frameRate.framesPerSecond = 24;
                break;
            case AudioPlayHead::fps25:
                context.frameRate.framesPerSecond = 25;
                break;
...
#if ! JUCE_MODAL_LOOPS_PERMITTED
            static void menuFinished (int modalResult, ComSmartPtr<ContextMenu> menu)  {
    ...
    public:
        ...
        */
        ...
        IPluginFactory* getPluginFactory()      {
            return dllHandle->getPluginFactory();
        }
...
//==============================================================================
    ...
    public:
        ...
        bool acceptsMidi() const override    {
            return getBusInfo (true,  false).channelCount > 0;
        }
        bool producesMidi() const override   {
            return getBusInfo (false, false).channelCount > 0;
        }
        ...
        int getNumPrograms() override                        {
            return getProgramListInfo (0).programCount;
        }
