...
SamplerSound::SamplerSound (const String& soundName,
                            ...
                            const double maxSampleLengthSeconds_)
    : name (soundName),
      midiRootNote (60),
      maxSampleLengthSeconds(maxSampleLengthSeconds_)
{
    change_sample( source );
}
...
void SamplerSound::change_sample( AudioFormatReader& source ) {
