...
UiLookAndFeel::UiLookAndFeel()
{
    ...
    //defaultFont = Font(Typeface::createSystemTypefaceFor(BinaryData::OpenSans_woff2,BinaryData::OpenSans_woff2Size));
...
//==============================================================================
void UiLookAndFeel::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void UiLookAndFeel::drawSpinningWaitAnimation (Graphics& g, const Colour& colour, int x, int y, int w, int h)
{
...
bool UiLookAndFeel::areScrollbarButtonsVisible()
{
    return true;
}

void UiLookAndFeel::drawScrollbarButton (Graphics& g, ScrollBar& scrollbar,
...
void UiLookAndFeel::drawScrollbar (Graphics& g,
                                   ScrollBar& scrollbar,
                                   int x, int y,
                                   int width, int height,
                                   bool isScrollbarVertical,
    ...
    */
    if (isScrollbarVertical)
    {
        slotPath.addRoundedRectangle (x + slotIndent,
                                      ...
                                      width - slotIndentx2,
                                      height - slotIndentx2,
                                      (width - slotIndentx2) * 0.2f);

        slotPathInner.addRoundedRectangle (x + slotIndent+1,
                                           y + slotIndent+1,
                                           width - slotIndentx2-2,
                                           height - slotIndentx2-2,
...
ImageEffectFilter* UiLookAndFeel::getScrollbarEffect()
{
    return nullptr;
}
...
int UiLookAndFeel::getDefaultScrollbarWidth()
{
    return 18;
}
...
bool UiLookAndFeel::areLinesDrawnForTreeView (TreeView&)
{
    return true;
}

int UiLookAndFeel::getTreeViewIndentSize (TreeView&)
{
    return 24;
}

//==============================================================================
void UiLookAndFeel::drawBubble (Graphics& g, BubbleComponent& comp,
...
//==============================================================================
int UiLookAndFeel::getMenuWindowFlags()
{
    return ComponentPeer::windowHasDropShadow;
}

void UiLookAndFeel::drawMenuBarBackground (Graphics& g, int width, int height, bool, MenuBarComponent& menuBar)
{
...
Font UiLookAndFeel::getMenuBarFont (MenuBarComponent& menuBar, int /*itemIndex*/, const String& /*itemText*/)
{
    return Font (menuBar.getHeight() * 0.7f);
}

int UiLookAndFeel::getMenuBarItemWidth (MenuBarComponent& menuBar, int itemIndex, const String& itemText)
{
    return getMenuBarFont (menuBar, itemIndex, itemText)
           .getStringWidth (itemText) + menuBar.getHeight();
}

void UiLookAndFeel::drawMenuBarItem (Graphics& g, int width, int height,
...
ImageEffectFilter* UiLookAndFeel::getSliderEffect (Slider&) {
    return nullptr;
}
...
void UiLookAndFeel::layoutFilenameComponent (FilenameComponent& filenameComp,
...
//==============================================================================
void UiLookAndFeel::drawImageButton (Graphics& g, Image* image,
...
int UiLookAndFeel::getDefaultMenuBarHeight()
{
    return 24;
}
...
//==============================================================================
int UiLookAndFeel::getTabButtonOverlap (int tabDepth)
{
    return 1 + tabDepth / 3;
}

int UiLookAndFeel::getTabButtonSpaceAroundImage()
{
    return 4;
}
...
Rectangle<int> UiLookAndFeel::getTabButtonExtraComponentBounds (const TabBarButton& button, Rectangle<int>& textArea, Component& comp)
{
...
void UiLookAndFeel::createTabButtonShape (TabBarButton& button, Path& p, bool /*isMouseOver*/, bool /*isMouseDown*/)
{
...
void UiLookAndFeel::drawTabButtonText (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
...
void UiLookAndFeel::drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
    Path tabShape;
...
void UiLookAndFeel::drawTabAreaBehindFrontButton (TabbedButtonBar& bar, Graphics& g, const int w, const int h)
{
...
//==============================================================================
void UiLookAndFeel::drawPropertyPanelSectionHeader (Graphics& g, const String& name,
...
void UiLookAndFeel::drawPropertyComponentBackground (Graphics& g, int width, int height, PropertyComponent& component)
{
    g.setColour (component.findColour (PropertyComponent::backgroundColourId));
    g.fillRect (0, 0, width, height - 1);
}

void UiLookAndFeel::drawPropertyComponentLabel (Graphics& g, int, int height, PropertyComponent& component)
{
...
//==============================================================================
void UiLookAndFeel::drawCallOutBoxBackground (CallOutBox& box, Graphics& g,
...
void UiLookAndFeel::drawFileBrowserRow (Graphics& g, int width, int height,
...
Button* UiLookAndFeel::createFileBrowserGoUpButton()
{
    ...
    arrowImage.setFill (Colour(0xffff3b00));
...
//==============================================================================
void UiLookAndFeel::drawKeymapChangeButton (Graphics& g, int width, int height, Button& button, const String& keyDescription)
{
...
//==============================================================================
void UiLookAndFeel::drawBevel (Graphics& g, const int x, const int y, const int width, const int height,
