...
//==============================================================================
Monique_Ui_ENVPopup::Monique_Ui_ENVPopup (Monique_Ui_Mainwindow*const parent_, ENVData*const env_data_, Parameter*const sustain_, bool left_)
...
#include "mono_ui_includeHacks_BEGIN.h"
    ...
    plotter->setBounds (410, 30, 280, 139);
    ...
    label_sustain_bottom->setBounds (140, 140, 60, 33);
    label_sustain->setBounds (140, 20, 60, 33);
    plotter->setBounds (410, 20, 280, 159);
    slider_env_shape->setBounds (340, 60, 60, 80);
    label_shape->setBounds (340, 140, 60, 33);
    internalPath1.clear();
...
<JUCER_COMPONENT documentType="Component" className="Monique_Ui_ENVPopup" componentName=""
                 ...
                 constructorParams="Monique_Ui_Mainwindow*const parent_, ENVData*const env_data_, Parameter*const sustain_, bool left_"
  ...
  <GENERICCOMPONENT name="" id="c88b6f548bad2da7" memberName="plotter" virtualName=""
                    explicitFocusOrder="0" pos="410 20 280 159" class="Component"
                    params=""/>
