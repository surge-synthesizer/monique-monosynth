...
#include "UiDynamicSizeStart.h"
    ...
    g.drawRoundedRectangle (20.0f, 10.0f, 190.0f, 135.0f, 6.000f, 1.000f);

    g.setColour (Colour (0xffff3b00));
    g.drawRoundedRectangle (210.0f, 10.0f, 180.0f, 135.0f, 6.000f, 1.000f);

    g.setColour (Colour (0xffff3b00));
    g.drawRoundedRectangle (720.0f, 10.0f, 260.0f, 135.0f, 6.000f, 1.000f);

    g.setColour (Colour (0xffff3b00));
    g.drawRoundedRectangle (981.0f, 10.0f, 450.0f, 135.0f, 6.000f, 1.000f);

    g.setColour (Colour (0xffff3b00));
    g.drawRoundedRectangle (390.0f, 10.0f, 330.0f, 135.0f, 6.000f, 1.000f);
...
void UiEditorGlobalSettings::resized()
{
    ...
    label_colour_9->setBounds (1300, 90, 120, 33);
    button_current_editor_color->setBounds (1340, 40, 70, 70);
    colour_selector->setBounds (1000, 30, 330, 90);
    label_colour_6->setBounds (1170, 90, 110, 33);
    label_colour_4->setBounds (1170, 30, 110, 33);
    label_colour_5->setBounds (1170, 60, 110, 33);
    slider_morph_motor_time->setBounds (40, 30, 60, 70);
    slider_glide_time->setBounds (130, 30, 60, 70);
    label13->setBounds (20, 100, 100, 33);
    label7->setBounds (130, 100, 60, 33);
    label_16->setBounds (260, 40, 120, 33);
    toggle_animate_input_env->setBounds (220, 40, 33, 33);
    label_18->setBounds (260, 70, 120, 33);
    toggle_animate_eq_env->setBounds (220, 70, 33, 33);
    label_19->setBounds (260, 100, 120, 33);
    toggle_output_cc_mute4->setBounds (220, 100, 33, 33);
    label_ui_headline_1->setBounds (40, -4, 150, 35);
    label_ui_headline_2->setBounds (230, -4, 150, 35);
    label_2->setBounds (550, 70, 60, 33);
    label_cpu_usage->setBounds (620, 70, 80, 33);
    label_4->setBounds (550, 100, 60, 33);
    combo_multicore_cpus->setBounds (620, 100, 80, 30);
    label_ui_headline_4->setBounds (770, -4, 180, 35);
    slider_morph_motor_time2->setBounds (750, 30, 60, 70);
    label2->setBounds (730, 100, 100, 33);
    label_3->setBounds (880, 40, 100, 33);
    label_5->setBounds (880, 70, 100, 33);
    label_6->setBounds (880, 100, 100, 33);
    toggle_animate_input_env2->setBounds (850, 40, 33, 33);
    toggle_animate_input_env3->setBounds (850, 70, 33, 33);
    toggle_animate_input_env4->setBounds (850, 100, 33, 33);
    label_ui_headline_5->setBounds (1130, -4, 180, 35);
    label_colour_1->setBounds (1030, 30, 110, 33);
    label_colour_7->setBounds (1300, 30, 120, 33);
    label_colour_8->setBounds (1300, 60, 120, 33);
    label_colour_2->setBounds (1030, 60, 110, 33);
    button_colour_bg->setBounds (1000, 30, 33, 30);
    button_colour_border->setBounds (1000, 60, 33, 30);
    button_colour_buttons_on->setBounds (1140, 30, 33, 30);
    button_colour_slider_1->setBounds (1270, 30, 33, 30);
    button_colour_slider_2->setBounds (1270, 60, 33, 30);
    button_colour_slider_mod->setBounds (1270, 90, 33, 30);
    label_colour_3->setBounds (1030, 90, 110, 33);
    button_colour_signal_lines->setBounds (1000, 90, 33, 30);
    button_colour_buttons_off->setBounds (1140, 60, 33, 30);
    button_colour_labels->setBounds (1140, 90, 33, 30);
    label_ui_headline_6->setBounds (470, 0, 170, 35);
    label_7->setBounds (400, 70, 60, 33);
    combo_audio_device->setBounds (470, 70, 80, 30);
    label_8->setBounds (400, 100, 60, 33);
    label_9->setBounds (550, 40, 60, 33);
    combo_sample_rate->setBounds (470, 100, 80, 30);
    combo_block_size->setBounds (620, 40, 80, 30);
    label_10->setBounds (400, 40, 60, 33);
    combo_audio_driver->setBounds (470, 40, 80, 30);
...
<JUCER_COMPONENT documentType="Component" className="UiEditorGlobalSettings" componentName=""
  ...
  <BACKGROUND backgroundColour="ff050505">
    <ROUNDRECT pos="20 10 190 135" cornerSize="6" fill="solid: 50505" hasStroke="1"
               stroke="1, mitered, butt" strokeColour="solid: ffff3b00"/>
    <ROUNDRECT pos="210 10 180 135" cornerSize="6" fill="solid: 0" hasStroke="1"
               stroke="1, mitered, butt" strokeColour="solid: ffff3b00"/>
    <ROUNDRECT pos="720 10 260 135" cornerSize="6" fill="solid: 0" hasStroke="1"
               stroke="1, mitered, butt" strokeColour="solid: ffff3b00"/>
    <ROUNDRECT pos="981 10 450 135" cornerSize="6" fill="solid: 0" hasStroke="1"
               stroke="1, mitered, butt" strokeColour="solid: ffff3b00"/>
    <ROUNDRECT pos="390 10 330 135" cornerSize="6" fill="solid: 0" hasStroke="1"
               stroke="1, mitered, butt" strokeColour="solid: ffff3b00"/>
  </BACKGROUND>
  <LABEL name="" id="f570869fba483c15" memberName="label_colour_9" virtualName=""
         explicitFocusOrder="0" pos="1300 90 120 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="d6b2a5702bcb546f" memberName="label_colour_5" virtualName=""
         explicitFocusOrder="0" pos="1170 60 110 33" textCol="ffff3b00"
  ...
  <SLIDER name="0" id="30eb597ef479a74e" memberName="slider_morph_motor_time"
          virtualName="Slider" explicitFocusOrder="0" pos="40 30 60 70"
  ...
  <SLIDER name="0" id="c244467fb56dffee" memberName="slider_glide_time"
          virtualName="Slider" explicitFocusOrder="0" pos="130 30 60 70"
          rotarysliderfill="ffffff00" rotaryslideroutline="ff161616" textboxtext="ffffff00"
          textboxbkgd="ff161616" min="1" max="20000" int="1" style="RotaryHorizontalVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <LABEL name="new label" id="796db125cec623bd" memberName="label13" virtualName=""
         explicitFocusOrder="0" pos="20 100 100 33" textCol="ffffff00"
  ...
  <LABEL name="new label" id="2c68301961d63e82" memberName="label7" virtualName=""
         explicitFocusOrder="0" pos="130 100 60 33" textCol="ffffff00"
  ...
  <LABEL name="" id="dfd8e91824767f78" memberName="label_16" virtualName=""
         explicitFocusOrder="0" pos="260 40 120 33" textCol="ffff3b00"
  ...
  <TOGGLEBUTTON name="" id="f342323c5495d0a1" memberName="toggle_animate_input_env"
                virtualName="" explicitFocusOrder="0" pos="220 40 33 33" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <LABEL name="" id="55ed48882dea6ac8" memberName="label_18" virtualName=""
         explicitFocusOrder="0" pos="260 70 120 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="48465e518b2a9587" memberName="label_19" virtualName=""
         explicitFocusOrder="0" pos="260 100 120 33" textCol="ffff3b00"
  ...
  <TOGGLEBUTTON name="" id="13a54c23c88819cb" memberName="toggle_output_cc_mute4"
                virtualName="" explicitFocusOrder="0" pos="220 100 33 33" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <LABEL name="DL" id="b59f286362d58d43" memberName="label_ui_headline_1"
         virtualName="" explicitFocusOrder="0" pos="40 -4 150 35" textCol="ff1111ff"
  ...
  <LABEL name="DL" id="b5bc2cbedd6ff2b1" memberName="label_ui_headline_2"
         virtualName="" explicitFocusOrder="0" pos="230 -4 150 35" textCol="ff1111ff"
  ...
  <LABEL name="" id="a5e27df00dd3061" memberName="label_2" virtualName=""
         explicitFocusOrder="0" pos="550 70 60 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="6ddda2710d986dce" memberName="label_cpu_usage" virtualName=""
         explicitFocusOrder="0" pos="620 70 80 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="5a530fedc3a6cb0" memberName="label_4" virtualName=""
         explicitFocusOrder="0" pos="550 100 60 33" textCol="ffff3b00"
  ...
  <COMBOBOX name="" id="78586adbf5ab9e5a" memberName="combo_multicore_cpus"
            virtualName="" explicitFocusOrder="0" pos="620 100 80 30" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="DL" id="dd5b53cdc2ebaa9f" memberName="label_ui_headline_4"
         virtualName="" explicitFocusOrder="0" pos="770 -4 180 35" textCol="ff1111ff"
  ...
  <SLIDER name="0" id="ada70618221d405" memberName="slider_morph_motor_time2"
          virtualName="Slider" explicitFocusOrder="0" pos="750 30 60 70"
          rotarysliderfill="ffffff00" rotaryslideroutline="ff161616" textboxtext="ffffff00"
  ...
  <LABEL name="new label" id="e594adc8a1c69523" memberName="label2" virtualName=""
         explicitFocusOrder="0" pos="730 100 100 33" textCol="ffffff00"
  ...
  <LABEL name="" id="308a6ce808eddf2e" memberName="label_3" virtualName=""
         explicitFocusOrder="0" pos="880 40 100 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="70949c3310a2e558" memberName="label_5" virtualName=""
         explicitFocusOrder="0" pos="880 70 100 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="c89a79c1406a0ae0" memberName="label_6" virtualName=""
         explicitFocusOrder="0" pos="880 100 100 33" textCol="ffff3b00"
  ...
  <TOGGLEBUTTON name="" id="992c96a954884e8b" memberName="toggle_animate_input_env2"
                virtualName="" explicitFocusOrder="0" pos="850 40 33 33" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="" id="83332647a3954a0b" memberName="toggle_animate_input_env3"
                virtualName="" explicitFocusOrder="0" pos="850 70 33 33" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="" id="3a61c0b11e0af4ba" memberName="toggle_animate_input_env4"
                virtualName="" explicitFocusOrder="0" pos="850 100 33 33" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <LABEL name="DL" id="9eb0361b7a0444ac" memberName="label_ui_headline_5"
         virtualName="" explicitFocusOrder="0" pos="1130 -4 180 35" textCol="ff1111ff"
  ...
  <LABEL name="" id="55a3217ef78a3c61" memberName="label_colour_1" virtualName=""
         explicitFocusOrder="0" pos="1030 30 110 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="bb43131d9973a62b" memberName="label_colour_7" virtualName=""
         explicitFocusOrder="0" pos="1300 30 120 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="414941fefbe1a3cf" memberName="label_colour_8" virtualName=""
         explicitFocusOrder="0" pos="1300 60 120 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="2efba9c3ce22653b" memberName="label_colour_2" virtualName=""
         explicitFocusOrder="0" pos="1030 60 110 33" textCol="ffff3b00"
  ...
  <TEXTBUTTON name="new button" id="914ce4dd638de5f3" memberName="button_colour_bg"
              virtualName="" explicitFocusOrder="0" pos="1000 30 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="new button" id="e427e1f8d74ea481" memberName="button_colour_border"
              virtualName="" explicitFocusOrder="0" pos="1000 60 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="new button" id="2bde73aa342c2457" memberName="button_colour_slider_1"
              virtualName="" explicitFocusOrder="0" pos="1270 30 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="new button" id="8ddcc2620647afb5" memberName="button_colour_slider_2"
              virtualName="" explicitFocusOrder="0" pos="1270 60 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="new button" id="27311d6a38d6510d" memberName="button_colour_slider_mod"
              virtualName="" explicitFocusOrder="0" pos="1270 90 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="" id="af67a383712e7be7" memberName="label_colour_3" virtualName=""
         explicitFocusOrder="0" pos="1030 90 110 33" textCol="ffff3b00"
  ...
  <TEXTBUTTON name="new button" id="a907651961c48243" memberName="button_colour_signal_lines"
              virtualName="" explicitFocusOrder="0" pos="1000 90 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="new button" id="aa8131218b1a4e24" memberName="button_colour_buttons_off"
              virtualName="" explicitFocusOrder="0" pos="1140 60 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="new button" id="16cb69a9f61a0c7f" memberName="button_colour_labels"
              virtualName="" explicitFocusOrder="0" pos="1140 90 33 30" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="DL" id="668d26bcc5860c72" memberName="label_ui_headline_6"
         virtualName="" explicitFocusOrder="0" pos="470 0 170 35" textCol="ff1111ff"
  ...
  <LABEL name="" id="e0756600ee1aa0c2" memberName="label_7" virtualName=""
         explicitFocusOrder="0" pos="400 70 60 33" textCol="ffff3b00"
  ...
  <COMBOBOX name="" id="efb590c00df9d613" memberName="combo_audio_device"
            virtualName="" explicitFocusOrder="0" pos="470 70 80 30" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="" id="49f12ab9e3d54910" memberName="label_8" virtualName=""
         explicitFocusOrder="0" pos="400 100 60 33" textCol="ffff3b00"
  ...
  <LABEL name="" id="9e7b39300fbdcd67" memberName="label_9" virtualName=""
         explicitFocusOrder="0" pos="550 40 60 33" textCol="ffff3b00"
  ...
  <COMBOBOX name="" id="db95d5d8a64a8ebc" memberName="combo_sample_rate"
            virtualName="" explicitFocusOrder="0" pos="470 100 80 30" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <COMBOBOX name="" id="d76df912445a2ff8" memberName="combo_block_size" virtualName=""
            explicitFocusOrder="0" pos="620 40 80 30" editable="0" layout="33"
            items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="" id="2c9d694778c498dc" memberName="label_10" virtualName=""
         explicitFocusOrder="0" pos="400 40 60 33" textCol="ffff3b00"
  ...
  <COMBOBOX name="" id="f91daaa7098deafb" memberName="combo_audio_driver"
            virtualName="" explicitFocusOrder="0" pos="470 40 80 30" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
</JUCER_COMPONENT>
