                              ...
                              public Slider::Listener
{
  public:
    ...
    std::unique_ptr<Timer> clear_record_timer;
    std::unique_ptr<Timer> button_flasher;
  ...
  private:
    ...
    //==============================================================================
    std::unique_ptr<TextButton> filter_type_bg_button_5;
    std::unique_ptr<TextButton> filter_type_bg_button_4;
    std::unique_ptr<monique_ui_Overlay> overlay;
    std::unique_ptr<Label> label_monique;
    std::unique_ptr<CreditsPoper> pop_credits;
    std::unique_ptr<Label> label_fx_delay;
    ...
    std::unique_ptr<Label> label_lfo_3;
    std::unique_ptr<Label> label_lfo_2;
    std::unique_ptr<Label> label_lfo_1;
    ...
    std::unique_ptr<TextButton> button_edit_lfo_1;
    std::unique_ptr<TextButton> button_edit_lfo_2;
    std::unique_ptr<TextButton> button_edit_lfo_3;
    std::unique_ptr<TextButton> button_edit_input_env_3_3;
    std::unique_ptr<TextButton> button_edit_input_env_3_2;
    std::unique_ptr<TextButton> button_edit_input_env_3_1;
    std::unique_ptr<TextButton> button_edit_input_env_2_1;
    std::unique_ptr<TextButton> button_edit_input_env_2_2;
    std::unique_ptr<TextButton> button_edit_input_env_2_3;
    std::unique_ptr<TextButton> button_edit_input_env_1_3;
    std::unique_ptr<TextButton> button_edit_input_env_1_2;
    std::unique_ptr<TextButton> button_edit_input_env_1_1;
    std::unique_ptr<TextButton> button_edit_mfo_4;
    std::unique_ptr<TextButton> button_edit_mfo_3;
    std::unique_ptr<TextButton> button_edit_mfo_2;
    std::unique_ptr<TextButton> button_edit_mfo_1;
    std::unique_ptr<TextButton> button_edit_input_env_band_1;
    std::unique_ptr<TextButton> button_edit_input_env_band_2;
    std::unique_ptr<TextButton> effect_finalizer_switch2;
    std::unique_ptr<TextButton> button_edit_input_env_band_7;
    std::unique_ptr<TextButton> button_edit_input_env_band_3;
    std::unique_ptr<TextButton> button_edit_input_env_band_4;
    std::unique_ptr<TextButton> button_edit_input_env_band_5;
    std::unique_ptr<TextButton> button_edit_input_env_band_6;
    std::unique_ptr<TextButton> filter_type_bg_button_3;
    std::unique_ptr<TextButton> filter_type_2_3;
    std::unique_ptr<TextButton> filter_type_bg_button_2;
    std::unique_ptr<TextButton> filter_type_2_2;
    std::unique_ptr<TextButton> filter_type_bg_button_1;
    std::unique_ptr<TextButton> filter_type_2_1;
    std::unique_ptr<TextButton> button_toggle_morph_buttons_1;
    std::unique_ptr<TextButton> button_toggle_morph_buttons_2;
    std::unique_ptr<TextButton> button_toggle_morph_buttons_3;
    std::unique_ptr<TextButton> button_toggle_morph_buttons_4;
    std::unique_ptr<Label> label_band_hz_5;
    std::unique_ptr<Label> label_band_hz_6;
    std::unique_ptr<Label> label_band_hz_4;
    std::unique_ptr<Label> label_band_hz_1;
    std::unique_ptr<Label> label_morph;
    std::unique_ptr<Label> label_band_hz_7;
    std::unique_ptr<Label> label_arpeggiator;
    std::unique_ptr<TextButton> button_programm_replace;
    std::unique_ptr<TextButton> button_programm_new;
    std::unique_ptr<Monique_Ui_DualSlider> bypass;
    std::unique_ptr<Monique_Ui_DualSlider> colour;
    std::unique_ptr<Label> label_band_hz_2;
    std::unique_ptr<Label> label_band_hz_3;
    ...
    std::unique_ptr<TextButton> filter_type_3_1;
    std::unique_ptr<TextButton> filter_type_3_2;
    std::unique_ptr<TextButton> filter_type_3_3;
    std::unique_ptr<TextButton> filter_type_5_1;
    std::unique_ptr<TextButton> filter_type_5_2;
    std::unique_ptr<TextButton> filter_type_5_3;
    std::unique_ptr<TextButton> button_sequence_2;
    std::unique_ptr<TextButton> button_sequence_3;
    std::unique_ptr<TextButton> button_sequence_4;
    std::unique_ptr<TextButton> button_sequence_5;
    std::unique_ptr<TextButton> button_sequence_6;
    std::unique_ptr<TextButton> button_sequence_7;
    std::unique_ptr<TextButton> button_sequence_8;
    std::unique_ptr<TextButton> button_sequence_9;
    std::unique_ptr<TextButton> button_sequence_10;
    std::unique_ptr<TextButton> button_sequence_11;
    std::unique_ptr<TextButton> button_sequence_12;
    std::unique_ptr<TextButton> button_sequence_13;
    std::unique_ptr<TextButton> button_sequence_14;
    std::unique_ptr<TextButton> button_sequence_15;
    std::unique_ptr<TextButton> button_sequence_16;
    std::unique_ptr<ComboBox> combo_programm;
    std::unique_ptr<TextButton> button_programm_left;
    std::unique_ptr<TextButton> button_programm_right;
    std::unique_ptr<TextButton> button_open_oszi;
    std::unique_ptr<TextButton> button_open_midi_io_settings;
    std::unique_ptr<ComboBox> combo_bank;
    std::unique_ptr<TextButton> button_programm_load;
    ...
    std::unique_ptr<TextButton> button_sequence_1;
    ...
    std::unique_ptr<TextButton> button_arp_speed_XNORM;
    ...
    std::unique_ptr<TextButton> button_programm_delete;
    std::unique_ptr<TextButton> filter_type_6_1;
    std::unique_ptr<TextButton> filter_type_6_2;
    std::unique_ptr<TextButton> filter_type_6_3;
    std::unique_ptr<TextButton> button_ctrl_toggle;
    std::unique_ptr<Monique_Ui_DualSlider> speed;
    std::unique_ptr<TextButton> button_open_morph;
    std::unique_ptr<TextButton> effect_finalizer_switch;
    std::unique_ptr<TextButton> button_values_toggle;
    std::unique_ptr<Monique_Ui_DualSlider> octave_offset;
    std::unique_ptr<Label> label_filter_inputs;
    std::unique_ptr<Label> label_oscillators;
    std::unique_ptr<Label> label_filter_envelope;
    std::unique_ptr<Label> label_lfo;
    std::unique_ptr<Label> label_filter_config;
    std::unique_ptr<Label> label_filter_fx;
    std::unique_ptr<Label> label_out;
    std::unique_ptr<Label> label_amp_envelope;
    std::unique_ptr<Label> label_glide;
    std::unique_ptr<Label> label_speed;
    std::unique_ptr<Label> label_tune;
    std::unique_ptr<Label> label_fm;
    std::unique_ptr<Monique_Ui_SegmentedMeter> volume_master_meter;
    std::unique_ptr<TextButton> button_open_config2;
    std::unique_ptr<Label> label_mod_mix;
    ...
    std::unique_ptr<TextButton> button_reset_arp_tune;
    std::unique_ptr<TextButton> button_show_active_input_r_2_3;
    std::unique_ptr<TextButton> button_show_active_input_l_2_3;
    std::unique_ptr<TextButton> button_show_active_input_r_2_2;
    std::unique_ptr<TextButton> button_show_active_input_l_2_2;
    std::unique_ptr<TextButton> button_show_active_input_r_2_1;
    std::unique_ptr<TextButton> button_show_active_input_l_2_1;
    std::unique_ptr<TextButton> button_show_active_input_r_3_3;
    std::unique_ptr<TextButton> button_show_active_input_l_3_3;
    std::unique_ptr<TextButton> button_show_active_input_r_3_2;
    std::unique_ptr<TextButton> button_show_active_input_l_3_2;
    std::unique_ptr<TextButton> button_show_active_input_r_3_1;
    std::unique_ptr<TextButton> button_show_active_input_l_3_1;
    std::unique_ptr<TextButton> button_programm_rename;
    ...
    std::unique_ptr<TextButton> button_programm_scratch;
    std::unique_ptr<Monique_Ui_DualSlider> flt_shape_4;
    std::unique_ptr<Label> label_reverb;
    std::unique_ptr<TextButton> button_open_playback;
    ...
    std::unique_ptr<TextButton> button_flt_input_triggering_3_1;
    ...
    std::unique_ptr<TextButton> button_flt_input_triggering_1_1;
    std::unique_ptr<TextButton> button_flt_input_triggering_2_1;
    ...
    std::unique_ptr<Label> label_oscillators2;
    std::unique_ptr<Label> label_sub_poly;
    std::unique_ptr<Label> label_poly_desc_1;
    std::unique_ptr<Label> label_poly_desc_2;
    std::unique_ptr<Label> label_poly_desc_3;
    std::unique_ptr<Label> label_poly_desc_4;
    std::unique_ptr<Label> label_poly_desc_5;
    std::unique_ptr<Label> label_poly_desc_6;
    std::unique_ptr<Label> label_poly_desc_7;
    std::unique_ptr<Label> label_poly_desc_8;
    std::unique_ptr<Label> label_poly_desc_9;
    std::unique_ptr<Label> label_poly_desc_10;
    std::unique_ptr<Label> label_poly_desc_11;
    std::unique_ptr<Label> label_poly_desc_12;
    std::unique_ptr<Label> label_poly_desc_13;
    std::unique_ptr<Label> label_poly_desc_14;
    std::unique_ptr<Label> label_poly_desc_15;
    std::unique_ptr<Label> label_poly_desc_16;
    std::unique_ptr<TextButton> button_flt_input_triggering_1_2;
    std::unique_ptr<TextButton> button_flt_input_triggering_1_3;
    std::unique_ptr<TextButton> button_flt_input_triggering_2_2;
    std::unique_ptr<TextButton> button_flt_input_triggering_2_3;
    std::unique_ptr<TextButton> button_flt_input_triggering_3_2;
    std::unique_ptr<TextButton> button_flt_input_triggering_3_3;
