...
void Monique_Ui_Mainwindow::show_current_voice_data()
{
    ...
    button_on = look_and_feel->colours.get_theme( COLOUR_THEMES::FILTER_THEME ).button_on_colour;
    button_off = look_and_feel->colours.get_theme( COLOUR_THEMES::FILTER_THEME ).button_off_colour;
    // FILTER 1
    ...
    // SEQUENCE
    button_on = look_and_feel->colours.get_theme( COLOUR_THEMES::ARP_THEME ).button_on_colour;
    button_off = look_and_feel->colours.get_theme( COLOUR_THEMES::ARP_THEME ).button_off_colour;
    ...
    // MORPHERS
    button_on = look_and_feel->colours.get_theme( COLOUR_THEMES::MORPH_THEME ).button_on_colour;
    button_off = look_and_feel->colours.get_theme( COLOUR_THEMES::MORPH_THEME ).button_off_colour;
    ...
    // EDITORS
    button_on = look_and_feel->colours.get_theme( COLOUR_THEMES::TOP_THEME ).button_on_colour;
    button_off = look_and_feel->colours.get_theme( COLOUR_THEMES::TOP_THEME ).button_off_colour;
#ifdef IS_STANDALONE
    if( flash_counter > 0 )
    {
        flash_counter--;
    ...
    {
        button_open_midi_io_settings->setColour( TextButton::buttonColourId, editor_midiio ? button_on : button_off );
    }
#else
...
#endif
    button_open_oszi->setColour( TextButton::buttonColourId, amp_painter ? button_on : button_off );
    button_open_config2->setColour( TextButton::buttonColourId, editor_global_settings ? button_on : button_off );

    button_ctrl_toggle->setColour( TextButton::buttonColourId, synth_data->ctrl ? button_on : button_off );
    button_values_toggle->setColour( TextButton::buttonColourId, look_and_feel->show_values_always ? button_on : button_off );
...
void Monique_Ui_Mainwindow::resize_sequence_buttons()
{
    ...
    if( shuffle != last_shuffle )
    {
        ...
        for( int i = 0 ; i != sequence_buttons.size() ; ++i )
        {
            ...
            if( i % 4 == 0 )
            {
                button->setSize( use_shuffle, 25.0f * height_factor );
            }
            else if( i % 2 == 0  )
            {
                button->setSize( use_shuffle, 25.0f * height_factor );
...
{
    Colour& area =look_and_feel->colours.get_theme( COLOUR_THEMES::FX_THEME ).area_colour;
    effect_finalizer_switch2->setColour( TextButton::buttonColourId, fx_ ? area.withAlpha(0.5f) : area );
    effect_finalizer_switch->setColour( TextButton::buttonColourId, fx_ ? area : area.withAlpha(0.5f) );
    ...
    label_fx_section->setVisible( fx_ );
      ...
      original_w(1465), original_h(1235)
{
    ...
    filter_type_bg_button_3->addListener (this);
    ...
    filter_type_bg_button_2->addListener (this);
    ...
    filter_type_bg_button_1->addListener (this);
    ...
    addAndMakeVisible (lfo_minus_3 = new TextButton (String::empty));
    lfo_minus_3->setTooltip (TRANS("Decrease the LFO speed in steps."));
    lfo_minus_3->setButtonText (TRANS("-"));
    lfo_minus_3->addListener (this);
    lfo_minus_3->setColour (TextButton::buttonColourId, Colours::black);
    lfo_minus_3->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_minus_3->setColour (TextButton::textColourOffId, Colours::yellow);

    addAndMakeVisible (lfo_plus_3 = new TextButton (String::empty));
    lfo_plus_3->setTooltip (TRANS("Increase the LFO speed in steps."));
    lfo_plus_3->setButtonText (TRANS("+"));
    lfo_plus_3->addListener (this);
    lfo_plus_3->setColour (TextButton::buttonColourId, Colours::black);
    lfo_plus_3->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_plus_3->setColour (TextButton::textColourOffId, Colours::yellow);

    addAndMakeVisible (lfo_plus_2 = new TextButton (String::empty));
    lfo_plus_2->setTooltip (TRANS("Increase the LFO speed in steps."));
    lfo_plus_2->setButtonText (TRANS("+"));
    lfo_plus_2->addListener (this);
    lfo_plus_2->setColour (TextButton::buttonColourId, Colours::black);
    lfo_plus_2->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_plus_2->setColour (TextButton::textColourOffId, Colours::yellow);

    addAndMakeVisible (lfo_minus_2 = new TextButton (String::empty));
    lfo_minus_2->setTooltip (TRANS("Decrease the LFO speed in steps."));
    lfo_minus_2->setButtonText (TRANS("-"));
    lfo_minus_2->addListener (this);
    lfo_minus_2->setColour (TextButton::buttonColourId, Colours::black);
    lfo_minus_2->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_minus_2->setColour (TextButton::textColourOffId, Colours::yellow);

    addAndMakeVisible (lfo_plus_1 = new TextButton (String::empty));
    lfo_plus_1->setTooltip (TRANS("Increase the LFO speed in steps."));
    lfo_plus_1->setButtonText (TRANS("+"));
    lfo_plus_1->addListener (this);
    lfo_plus_1->setColour (TextButton::buttonColourId, Colours::black);
    lfo_plus_1->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_plus_1->setColour (TextButton::textColourOffId, Colours::yellow);

    addAndMakeVisible (lfo_minus_1 = new TextButton (String::empty));
    lfo_minus_1->setTooltip (TRANS("Decrease the LFO speed in steps."));
    lfo_minus_1->setButtonText (TRANS("-"));
    lfo_minus_1->addListener (this);
    lfo_minus_1->setColour (TextButton::buttonColourId, Colours::black);
    lfo_minus_1->setColour (TextButton::textColourOnId, Colour (0xffff3b00));
    lfo_minus_1->setColour (TextButton::textColourOffId, Colours::yellow);
    ...
    addAndMakeVisible (label_morph_osc = new Label (String::empty,
                                                    TRANS("OSC")));
    label_morph_osc->setFont (Font (30.00f, Font::plain));
    label_morph_osc->setJustificationType (Justification::centred);
    label_morph_osc->setEditable (false, false, false);
    label_morph_osc->setColour (Label::textColourId, Colour (0xffff3b00));
    label_morph_osc->setColour (TextEditor::textColourId, Colour (0xffff3b00));
    label_morph_osc->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (label_morph_flt = new Label (String::empty,
                                                    TRANS("FLT")));
    label_morph_flt->setFont (Font (30.00f, Font::plain));
    label_morph_flt->setJustificationType (Justification::centred);
    label_morph_flt->setEditable (false, false, false);
    label_morph_flt->setColour (Label::textColourId, Colour (0xffff3b00));
    label_morph_flt->setColour (TextEditor::textColourId, Colour (0xffff3b00));
    label_morph_flt->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (label_morph_fx = new Label (String::empty,
                                                   TRANS("FX")));
    label_morph_fx->setFont (Font (30.00f, Font::plain));
    label_morph_fx->setJustificationType (Justification::centred);
    label_morph_fx->setEditable (false, false, false);
    label_morph_fx->setColour (Label::textColourId, Colour (0xffff3b00));
    label_morph_fx->setColour (TextEditor::textColourId, Colour (0xffff3b00));
    label_morph_fx->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (label_morph_arp = new Label (String::empty,
                                                    TRANS("ARP")));
    label_morph_arp->setFont (Font (30.00f, Font::plain));
    label_morph_arp->setJustificationType (Justification::centred);
    label_morph_arp->setEditable (false, false, false);
    label_morph_arp->setColour (Label::textColourId, Colour (0xffff3b00));
    label_morph_arp->setColour (TextEditor::textColourId, Colour (0xffff3b00));
    label_morph_arp->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    ...
    button_edit_mfo_1->setTooltip (TRANS("Open/Close the morph editor.\n"
    "\n"
    "Note: press ESC to close editors."));
    ...
    button_edit_mfo_2->setTooltip (TRANS("Open/Close the morph editor.\n"
    "\n"
    "Note: press ESC to close editors."));
    ...
    button_edit_mfo_3->setTooltip (TRANS("Open/Close the morph editor.\n"
    "\n"
    "Note: press ESC to close editors."));
    ...
    button_edit_mfo_4->setTooltip (TRANS("Open/Close the morph editor.\n"
    "\n"
    "Note: press ESC to close editors."));
    ...
    addAndMakeVisible (label_fx_section = new Label (String::empty,
                                                     TRANS("FX SECTION")));
    label_fx_section->setFont (Font (30.00f, Font::plain));
    label_fx_section->setJustificationType (Justification::centred);
    label_fx_section->setEditable (false, false, false);
    label_fx_section->setColour (Label::textColourId, Colour (0xff050505));
    label_fx_section->setColour (TextEditor::textColourId, Colour (0xffff3b00));
    label_fx_section->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    ...
    sl_morhp_mix->getProperties().set( VAR_INDEX_SLIDER_TYPE, VALUE_SLIDER );
    ...
    // OPAQUE
    {
        ...
        label_fx_section->setOpaque(false);
    ...
    // THEMES
    {
        ...
        const SectionTheme* theme = &look_and_feel->colours.get_theme( COLOUR_THEMES::TOP_THEME );
        ...
        button_programm_new->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::TOP_THEME );
        button_programm_scratch->setColour(TextButton::buttonColourId, button_off);
        button_programm_scratch->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::TOP_THEME );
        ...
        button_reset_arp_tune->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::ARP_THEME );
        button_edit_mfo_1->setColour( TextButton::buttonColourId, button_off );
        button_edit_mfo_1->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        button_edit_mfo_2->setColour( TextButton::buttonColourId, button_off );
        button_edit_mfo_2->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        button_edit_mfo_3->setColour( TextButton::buttonColourId, button_off );
        button_edit_mfo_3->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        button_edit_mfo_4->setColour( TextButton::buttonColourId, button_off );
        button_edit_mfo_4->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        lfo_minus_1->setColour( TextButton::buttonColourId, button_off );
        lfo_minus_1->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        lfo_minus_2->setColour( TextButton::buttonColourId, button_off );
        lfo_minus_2->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        lfo_minus_3->setColour( TextButton::buttonColourId, button_off );
        lfo_minus_3->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        lfo_plus_1->setColour( TextButton::buttonColourId, button_off );
        lfo_plus_1->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        lfo_plus_2->setColour( TextButton::buttonColourId, button_off );
        lfo_plus_2->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        lfo_plus_3->setColour( TextButton::buttonColourId, button_off );
        lfo_plus_3->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
	...
	filter_type_bg_button_1->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        filter_type_bg_button_1->setColour( TextButton::buttonColourId, button_off );
	...
	filter_type_bg_button_2->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        filter_type_bg_button_2->setColour( TextButton::buttonColourId, button_off );
	...
	filter_type_bg_button_3->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FILTER_THEME );
        filter_type_bg_button_3->setColour( TextButton::buttonColourId, button_off );
	filter_type_bg_button_3->setEnabled(false);
        ...
        label_morph_osc->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        label_morph_flt->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        label_morph_arp->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );
        label_morph_fx->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::MORPH_THEME );

        label_amp_envelope->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FX_THEME );
        label_fx_section->getProperties().set( VAR_INDEX_COLOUR_THEME, COLOUR_THEMES::FX_THEME );
        ...
        theme = &look_and_feel->colours.get_theme( COLOUR_THEMES::FILTER_THEME );
        button_off = theme->button_off_colour;
        button_edit_input_env_1_1->setColour( TextButton::buttonColourId, button_off );
        button_edit_input_env_1_2->setColour( TextButton::buttonColourId, button_off );
        button_edit_input_env_1_3->setColour( TextButton::buttonColourId, button_off );
        button_edit_input_env_2_1->setColour( TextButton::buttonColourId, button_off );
...
Monique_Ui_Mainwindow::~Monique_Ui_Mainwindow()
{
    ...
    label_morph_osc = nullptr;
    label_morph_flt = nullptr;
    label_morph_fx = nullptr;
    label_morph_arp = nullptr;
...
#include "mono_ui_includeHacks_BEGIN.h"
    ...
    g.fillEllipse (796.0f, 136.0f, 100.0f, 100.0f);
    ...
    g.setColour (Colour (0xff1111ff));
    g.fillEllipse (801.0f, 141.0f, 90.0f, 90.0f);

    g.setColour (Colour (0xff050505));
    g.fillEllipse (796.0f, 316.0f, 100.0f, 100.0f);

    g.setColour (Colour (0xff1111ff));
    g.fillEllipse (801.0f, 321.0f, 90.0f, 90.0f);

    g.setColour (Colour (0xff050505));
    g.fillEllipse (796.0f, 496.0f, 100.0f, 100.0f);

    g.setColour (Colour (0xff1111ff));
    g.fillEllipse (801.0f, 501.0f, 90.0f, 90.0f);
...
void Monique_Ui_Mainwindow::resized()
{
    ...
    lfo_minus_3->setBounds (900, 480, 30, 30);
    lfo_plus_3->setBounds (930, 480, 30, 30);
    lfo_plus_2->setBounds (930, 300, 30, 30);
    lfo_minus_2->setBounds (900, 300, 30, 30);
    lfo_plus_1->setBounds (930, 120, 30, 30);
    lfo_minus_1->setBounds (900, 120, 30, 30);
    label_band_hz_5->setBounds (1085, 634, 50, 30);
    label_band_hz_6->setBounds (1145, 634, 50, 30);
    label_band_hz_4->setBounds (1015, 634, 50, 30);
    label_band_hz_1->setBounds (825, 634, 50, 30);
    ...
    label_band_hz_7->setBounds (1215, 634, 50, 30);
    ...
    delay2->setBounds (1060 - 60, 810 - 130, 60, 130);
    chorus_modulation->setBounds (910, 810 - 130, 60, 130);
    eq_2->setBounds (940 - 60, 810 - 130, 60, 130);
    label_band_hz_2->setBounds (885, 634, 50, 30);
    label_band_hz_3->setBounds (955, 634, 50, 30);
    ...
    adsr_lfo_mix->setBounds (818, 250 - 130, 60, 130);
    lfo_opt_2->setBounds (818, 430 - 130, 60, 130);
    lfo_opt_3->setBounds (818, 610 - 130, 60, 130);
    ...
    sl_morhp_mix->setBounds (5, 1240, 180, 30);
    ...
    label_morph_osc->setBounds (200, 810, 60, 30);
    label_morph_flt->setBounds (260, 810, 60, 30);
    label_morph_fx->setBounds (380, 810, 60, 30);
    label_morph_arp->setBounds (320, 810, 60, 30);
    ...
    label_fx_section->setBounds (820, 680, 260, 30);
...
void Monique_Ui_Mainwindow::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == filter_type_bg_button_3)
    {
        //[UserButtonCode_filter_type_bg_button_3] -- add your button handler code here..
        //[/UserButtonCode_filter_type_bg_button_3]
    }
    else if (buttonThatWasClicked == filter_type_bg_button_2)
    {
        //[UserButtonCode_filter_type_bg_button_2] -- add your button handler code here..
        //[/UserButtonCode_filter_type_bg_button_2]
    }
    else if (buttonThatWasClicked == filter_type_bg_button_1)
    {
        //[UserButtonCode_filter_type_bg_button_1] -- add your button handler code here..
        //[/UserButtonCode_filter_type_bg_button_1]
    }
    else if (buttonThatWasClicked == lfo_minus_3)
    {
        //[UserButtonCode_lfo_minus_3] -- add your button handler code here..
        synth_data->lfo_datas[2]->speed.set_value( int( synth_data->lfo_datas[2]->speed.get_value() - 1 ) );
        //[/UserButtonCode_lfo_minus_3]
    }
    else if (buttonThatWasClicked == lfo_plus_3)
    {
        //[UserButtonCode_lfo_plus_3] -- add your button handler code here..
        synth_data->lfo_datas[2]->speed.set_value( int( synth_data->lfo_datas[2]->speed.get_value() + 1 ) );
        //[/UserButtonCode_lfo_plus_3]
    }
    else if (buttonThatWasClicked == lfo_plus_2)
    {
        //[UserButtonCode_lfo_plus_2] -- add your button handler code here..
        synth_data->lfo_datas[1]->speed.set_value( int( synth_data->lfo_datas[1]->speed.get_value() + 1 ) );
        //[/UserButtonCode_lfo_plus_2]
    }
    else if (buttonThatWasClicked == lfo_minus_2)
    {
        //[UserButtonCode_lfo_minus_2] -- add your button handler code here..
        synth_data->lfo_datas[1]->speed.set_value( int( synth_data->lfo_datas[1]->speed.get_value() - 1 ) );
        //[/UserButtonCode_lfo_minus_2]
    }
    else if (buttonThatWasClicked == lfo_plus_1)
    {
        //[UserButtonCode_lfo_plus_1] -- add your button handler code here..
        synth_data->lfo_datas[0]->speed.set_value( int( synth_data->lfo_datas[0]->speed.get_value() + 1 ) );
        //[/UserButtonCode_lfo_plus_1]
    }
    else if (buttonThatWasClicked == lfo_minus_1)
    {
        //[UserButtonCode_lfo_minus_1] -- add your button handler code here..
        synth_data->lfo_datas[0]->speed.set_value( int( synth_data->lfo_datas[0]->speed.get_value() - 1 ) );
        //[/UserButtonCode_lfo_minus_1]
    }
    ...
    else if (buttonThatWasClicked == button_programm_new)
    {
        ...
        {
            combo_programm->setText( "NEW PROGRAM FROM SCRATCH", dontSendNotification );
        }
        combo_programm->setEditableText(true);
...
void Monique_Ui_Mainwindow::open_mfo_popup( MFOData*const mfo_data_, Button*const for_comp_, Monique_Ui_DualSlider*slider_ ) noexcept
{
    SectionTheme& theme = look_and_feel->colours.get_theme( COLOUR_THEMES::MORPH_THEME );
    Colour button_off = theme.button_off_colour;
    ...
    if( ! mfo_popup  )
    {
        if( mfo_data_ )
        {
            ...
            addAndMakeVisible( mfo_popup = new Monique_Ui_MFOPopup( ui_refresher, this, mfo_data_ ) );
    ...
    else
    {
        ...
        {
            mfo_popup = nullptr;
            open_mfo_popup( mfo_data_, for_comp_, slider_ );
        }
    }
}
...
{
    SectionTheme& theme = look_and_feel->colours.get_theme( COLOUR_THEMES::FILTER_THEME );
    Colour button_off = theme.button_off_colour;
    Colour button_on = theme.button_on_colour;
    button_edit_input_env_1_1->setColour( TextButton::buttonColourId, button_off );
    button_edit_input_env_1_2->setColour( TextButton::buttonColourId, button_off );
    ...
    else
    {
        if( env_popup->is_open_for() == env_data_ )
        {
            if( for_comp_ )
            {
                for_comp_->setColour( TextButton::buttonColourId, button_off );
            }
            env_popup = nullptr;
        }
...
bool Monique_Ui_Mainwindow::handle_keep_mfo_open( ModulationSliderConfigBase*const caller_config_ ) noexcept
{
    ...
    if( mfo_popup )
    {
        if( not caller_config_->action_keep_env_pop_open_for( mfo_popup->is_open_for() ) )
        {
            if( synth_data->auto_close_env_popup )
            {
                open_mfo_popup(nullptr,nullptr,nullptr);
            }
        }
        else
        {
...
<JUCER_COMPONENT documentType="Component" className="Monique_Ui_Mainwindow" componentName=""
  ...
  <BACKGROUND backgroundColour="ff050505">
    ...
    <ELLIPSE pos="796 136 100 100" fill="solid: ff050505" hasStroke="0"/>
    ...
    <ROUNDRECT pos="1000 290 450 150" cornerSize="10" fill="solid: ff1111ff"
               hasStroke="0"/>
    <ELLIPSE pos="801 141 90 90" fill="solid: ff1111ff" hasStroke="0"/>
    <ELLIPSE pos="796 316 100 100" fill="solid: ff050505" hasStroke="0"/>
    <ELLIPSE pos="801 321 90 90" fill="solid: ff1111ff" hasStroke="0"/>
    <ELLIPSE pos="796 496 100 100" fill="solid: ff050505" hasStroke="0"/>
    <ELLIPSE pos="801 501 90 90" fill="solid: ff1111ff" hasStroke="0"/>
  ...
  <TEXTBUTTON name="" id="40809d639d290176" memberName="filter_type_bg_button_1"
              ...
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText=""
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="8c39ab7393370d86" memberName="lfo_minus_3" virtualName=""
              explicitFocusOrder="0" pos="900 480 30 30" tooltip="Decrease the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="-"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="28468341a9b0ce40" memberName="lfo_plus_3" virtualName=""
              explicitFocusOrder="0" pos="930 480 30 30" tooltip="Increase the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="+"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="a57c998e83ac1511" memberName="lfo_plus_2" virtualName=""
              explicitFocusOrder="0" pos="930 300 30 30" tooltip="Increase the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="+"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="82bb010a8b22d92" memberName="lfo_minus_2" virtualName=""
              explicitFocusOrder="0" pos="900 300 30 30" tooltip="Decrease the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="-"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="b9c09c85829baa4c" memberName="lfo_plus_1" virtualName=""
              explicitFocusOrder="0" pos="930 120 30 30" tooltip="Increase the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="+"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="ff7ac483f2e2c468" memberName="lfo_minus_1" virtualName=""
              explicitFocusOrder="0" pos="900 120 30 30" tooltip="Decrease the LFO speed in steps."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="-"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="DL" id="89a933c800933b8f" memberName="label_band_hz_5"
         virtualName="" explicitFocusOrder="0" pos="1085 634 50 30" textCol="ff050505"
  ...
  <LABEL name="DL" id="8a859696dca2f1f0" memberName="label_band_hz_6"
         virtualName="" explicitFocusOrder="0" pos="1145 634 50 30" textCol="ff050505"
  ...
  <LABEL name="DL" id="ec2bcb9f1c216890" memberName="label_band_hz_4"
         virtualName="" explicitFocusOrder="0" pos="1015 634 50 30" textCol="ff050505"
  ...
  <LABEL name="DL" id="b8619ebb44316d58" memberName="label_band_hz_1"
         virtualName="" explicitFocusOrder="0" pos="825 634 50 30" textCol="ff050505"
  ...
  <TEXTBUTTON name="" id="4ed4547628245141" memberName="button_edit_input_env_3_3"
              virtualName="" explicitFocusOrder="0" pos="320 580 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="1d93900dcb94156f" memberName="button_edit_input_env_3_2"
              virtualName="" explicitFocusOrder="0" pos="260 580 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="1d4a552f9f250c90" memberName="button_edit_input_env_3_1"
              virtualName="" explicitFocusOrder="0" pos="200 580 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="DL" id="ceab7b618b72215f" memberName="label_band_hz_7"
         virtualName="" explicitFocusOrder="0" pos="1215 634 50 30" textCol="ff050505"
         edTextCol="ffff3b00" edBkgCol="0" labelText="&gt;2.5kHz" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
  ...
  <GENERICCOMPONENT name="" id="49d3d717347ff877" memberName="delay2" virtualName=""
                    explicitFocusOrder="0" pos="1060r 810r 60 130" class="Monique_Ui_DualSlider"
                    params="ui_refresher, &#10;new DelaySlConfig(synth_data)"/>
  <GENERICCOMPONENT name="" id="9378cae1ce589256" memberName="chorus_modulation"
                    virtualName="" explicitFocusOrder="0" pos="910 810r 60 130" class="Monique_Ui_DualSlider"
                    params="ui_refresher, &#10;new CModSlConfig(synth_data)"/>
  ...
  <LABEL name="DL" id="4c9a611da59481e8" memberName="label_band_hz_2"
         virtualName="" explicitFocusOrder="0" pos="885 634 50 30" textCol="ff050505"
  ...
  <LABEL name="DL" id="9e42519baddf946e" memberName="label_band_hz_3"
         virtualName="" explicitFocusOrder="0" pos="955 634 50 30" textCol="ff050505"
  ...
  <GENERICCOMPONENT name="" id="68cebc996c492894" memberName="adsr_lfo_mix" virtualName=""
                    explicitFocusOrder="0" pos="818 250r 60 130" class="Monique_Ui_DualSlider"
                    params="ui_refresher, &#10;new EnvLfoSlConfig(synth_data,0)"/>
  <GENERICCOMPONENT name="" id="944e7d4439e86773" memberName="lfo_opt_2" virtualName=""
                    explicitFocusOrder="0" pos="818 430r 60 130" class="Monique_Ui_DualSlider"
                    params="ui_refresher, &#10;new EnvLfoSlConfig(synth_data,1)"/>
  <GENERICCOMPONENT name="" id="2d0d9d7f81f143" memberName="lfo_opt_3" virtualName=""
                    explicitFocusOrder="0" pos="818 610r 60 130" class="Monique_Ui_DualSlider"
                    params="ui_refresher, &#10;new EnvLfoSlConfig(synth_data,2)"/>
  ...
  <SLIDER name="new slider" id="20de89a2be986cc1" memberName="sl_morhp_mix"
          virtualName="" explicitFocusOrder="0" pos="5 1240 180 30" tooltip="Morph between the morph sliders. &#10;&#10;Take a look at the MORPH MOTOR time in the SETUP to control the speed of this morph."
  ...
  <TEXTBUTTON name="" id="f57674183a67085" memberName="effect_finalizer_switch"
              ...
              connectedEdges="4" needsCallback="1" radioGroupId="0"/>
  <LABEL name="" id="af640d06672c6a96" memberName="label_morph_osc" virtualName=""
         explicitFocusOrder="0" pos="200 810 60 30" textCol="ffff3b00"
         edTextCol="ffff3b00" edBkgCol="0" labelText="OSC" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
  <LABEL name="" id="6cf55c2697d84492" memberName="label_morph_flt" virtualName=""
         explicitFocusOrder="0" pos="260 810 60 30" textCol="ffff3b00"
         edTextCol="ffff3b00" edBkgCol="0" labelText="FLT" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
  <LABEL name="" id="31349ce13448848e" memberName="label_morph_fx" virtualName=""
         explicitFocusOrder="0" pos="380 810 60 30" textCol="ffff3b00"
         edTextCol="ffff3b00" edBkgCol="0" labelText="FX" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
  <LABEL name="" id="1e86fc07c2fe9e40" memberName="label_morph_arp" virtualName=""
         explicitFocusOrder="0" pos="320 810 60 30" textCol="ffff3b00"
  ...
  <TEXTBUTTON name="" id="b915f30bfb983dc7" memberName="button_edit_input_env_1_1"
              virtualName="" explicitFocusOrder="0" pos="200 220 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="cfad8aa44907e8cf" memberName="button_edit_input_env_1_2"
              virtualName="" explicitFocusOrder="0" pos="260 220 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="" id="6c31c6d826c76bfd" memberName="button_edit_input_env_2_1"
              virtualName="" explicitFocusOrder="0" pos="200 400 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="283cd78e11cc7a6e" memberName="button_edit_input_env_2_2"
              virtualName="" explicitFocusOrder="0" pos="260 400 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="47db5d103cbca51f" memberName="button_edit_input_env_2_3"
              virtualName="" explicitFocusOrder="0" pos="320 400 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="" id="55e4c7770dd6c6a5" memberName="button_edit_input_env_band_4"
              virtualName="" explicitFocusOrder="0" pos="1010 780 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="325021dee5961ad1" memberName="button_edit_input_env_band_5"
              virtualName="" explicitFocusOrder="0" pos="1080 780 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="7d42e1a02a42a873" memberName="button_edit_input_env_band_6"
              virtualName="" explicitFocusOrder="0" pos="1140 780 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="ac8fdd08954a9d8" memberName="button_edit_input_env_band_7"
              virtualName="" explicitFocusOrder="0" pos="1210 780 60 30" bgColOff="ff000000"
              textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="" id="ebfbc2e7bb21bbdc" memberName="button_edit_mfo_1"
              virtualName="" explicitFocusOrder="0" pos="260r 780 60 30" tooltip="Open/Close the morph editor.&#10;&#10;Note: press ESC to close editors."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="b0af912df34ced45" memberName="button_edit_mfo_2"
              virtualName="" explicitFocusOrder="0" pos="320r 780 60 30" tooltip="Open/Close the morph editor.&#10;&#10;Note: press ESC to close editors."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="bc837211a67f57ac" memberName="button_edit_mfo_3"
              virtualName="" explicitFocusOrder="0" pos="380r 780 60 30" tooltip="Open/Close the morph editor.&#10;&#10;Note: press ESC to close editors."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="971beb8b5ba3cae1" memberName="button_edit_mfo_4"
              virtualName="" explicitFocusOrder="0" pos="440r 780 60 30" tooltip="Open/Close the morph editor.&#10;&#10;Note: press ESC to close editors."
              bgColOff="ff000000" textCol="ffff3b00" textColOn="ffffff00" buttonText="&#9675;"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="" id="879633575acf68ee" memberName="label_reverb" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
  <LABEL name="" id="798798be2a99287c" memberName="label_fx_section" virtualName=""
         explicitFocusOrder="0" pos="820 680 260 30" textCol="ff050505"
         edTextCol="ffff3b00" edBkgCol="0" labelText="FX SECTION" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="30" bold="0" italic="0" justification="36"/>
</JUCER_COMPONENT>
